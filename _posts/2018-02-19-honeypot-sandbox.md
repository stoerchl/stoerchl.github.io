...
Because the connection between the VirtualBox Web Service and Cuckoo should be HTTPS, certificates have to be generated. A simple guide for this task can be found in the  [_Documentation of RemoteBox_](http://www.balgau.net/files/2015-01/remotebox.pdf) on page 12 and 13.<br>
